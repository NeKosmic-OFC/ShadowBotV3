...
╭══〘 ✯✯✯✯✯✯✯✯ 〙═╮
║═ *𝐍𝐞𝐊𝐨𝐭𝐢𝐧𝐞 - 𝐁𝐨𝐭*
║═ http://𝐍𝐞𝐊𝐨𝐭𝐢𝐧𝐞»𝓑𝓞𝓣.lihttp://Oℱịcιɑl.li
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
║➤ *✨𝗛ola, ${username}!!*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
...
conn.send3ButtonImg(m.chat, pp, menu, '©NeKotine - Bot', '𝙼𝙴𝙽𝚄 𝚂𝙸𝙼𝙿𝙻𝙴', `#menusimple`, '𝙼𝙴𝙽𝚄 𝙰𝚄𝙳𝙸𝙾𝚂', `#menuaudios`, '𝙶𝚁𝚄𝙿𝙾𝚂 𝙾𝙵𝙸𝙲𝙸𝙰𝙻𝙴𝚂', `#grupos`, m, false, { contextInfo: { mentionedJid }})   
