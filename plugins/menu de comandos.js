...
conn.send3ButtonImg(m.chat, pp, menu, '©NeKotine - Bot', '𝙼𝙴𝙽𝚄 𝚂𝙸𝙼𝙿𝙻𝙴', `#menusimple`, '𝙼𝙴𝙽𝚄 𝙰𝚄𝙳𝙸𝙾𝚂', `#menuaudios`, '𝙶𝚁𝚄𝙿𝙾𝚂 𝙾𝙵𝙸𝙲𝙸𝙰𝙻𝙴𝚂', `#grupos`, `𝙼𝙸𝙽𝙴𝙲𝚁𝙰𝙵𝚃`, `#minecraft`, m, false, { contextInfo: { mentionedJid }})   
